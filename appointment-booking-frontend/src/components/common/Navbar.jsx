    ...
    <nav className="bg-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <Link to="/testimonial" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
              Testimonials
            </Link>
            ...
            {!isAuthenticated ? (
              ...
              <>
                {isOwner && (
                  <Link to="/dashboard" className="bg-green-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-green-700">
                    Dashboard
                  </Link>
                )}
                <button
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link to="/testimonial" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
            Testimonials
          </Link>
          ...
          {!isAuthenticated ? (
            ...
            <>
              {isOwner && (
                <Link to="/dashboard" className="block px-3 py-2 rounded-md text-base font-medium bg-green-600 text-white hover:bg-green-700">
                  Dashboard
                </Link>
              )}
              <button
